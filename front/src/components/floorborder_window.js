...
const floorborderImages = [
  ...
  {
    image: 'floorborder7.jpg',
    title: 'Floor Border 7',

  },
  {
    image: 'floorborder8.jpg',
    title: 'Floor Border 8',

  },
  {
    image: 'floorborder9.jpg',
    title: 'Floor Border 9',
...
const handleSubmitOrder = (e) => {
  ...
  return (
    <div className="right-container">
       <h1 style={{ marginTop: '60px' }}>Floor Borders</h1>
      <div className="row">
